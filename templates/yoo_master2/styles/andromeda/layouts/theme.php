<?php
  ...
  */
  ...
  //
  // Needs 2 components
  // An "external" link configuration with something like "./index.php/de/?foo=features" instead of "#features"
  // And the definition(s) in the code of this page - mirroring the possible anchor-tags
  $scrollTo = "";
  if (isset($_GET["foo"])) {
    $para = $_GET["foo"];
    if ($para == "features") {
